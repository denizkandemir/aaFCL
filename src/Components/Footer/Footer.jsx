        ...
        <div className="footer-bottom-content-container">
          <div className="footer-content-container">
            ...
            <h3 className="footer-title"> Okulumuzun Projeleri </h3>
              <a className="footer-link" target="blank" href="https://www.meb.gov.tr"> <p className="footer-p"> Kodluyoruz   </p> </a>
              <a className="footer-link" target="blank" href="https://fclturkiye.eba.gov.tr"> <p className="footer-p"> Okullar Hayat Olsun  </p></a>
              <a className="footer-link" target="blank" href="https://www-eun-org.translate.goog/professional-development/future-classroom-lab?_x_tr_sch=http&_x_tr_sl=en&_x_tr_tl=tr&_x_tr_hl=tr&_x_tr_pto=tc"><p className="footer-p"> EkoSchool </p></a>
              <a className="footer-link" target="blank" href="https://fclturkiye.eba.gov.tr"> <p className="footer-p"> Sorunlarımızdan Sorumluyuz Projesi  </p></a>
