...
const LearningPlaces = [
    ...
    {
        id:1,
        imgs:[placeImg1,placeImg2,placeImg3,placeImg4,placeImg5,placeImg6],
    ...
    {
        id:2,
        imgs:[placeImg5,placeImg6,placeImg4,placeImg3,placeImg2,placeImg1],
    ...
    {
        id:3,
        imgs:[placeImg4,placeImg1,placeImg2,placeImg3,placeImg5,placeImg6],
        ...
        pageText:"Araştırma alanında öğrencilerimiz bilgi ve veri okuryazarlığı yeterlik düzeyi bağlamında online ortamlarda araştırma yaparlar, kendileri için ihtiyaç duydukları veriye, bilgiye veya dijital içeriklere nasıl erişebileceklerini; elde ettikleri içeriklere ve bilginin kaynağına eleştirel bakmayı ve bilgiyi kendi çalışmaları için nasıl organize edip kullanabileceklerini öğrenirler. ​Araştırma alanında bilgsayarlar,yazıcı,tabletler,3D yazıcı, drone, teleskop, robot masası, mbot, 3 adet arduino eğitim seti,STEM tasarım ve üretim ünitesi, yenilenebilir güneş enerji deney seti, rüzgar enerjisi deney seti bulunmaktadır.",

    },

    {
        id:4,
        imgs:[placeImg2,placeImg1,placeImg3,placeImg4,placeImg5,placeImg6],
    ...
    {
        id:5,
        imgs:[placeImg3,placeImg1,placeImg2,placeImg4,placeImg5,placeImg6],
        text:"Sunum alanı, öğrencilerin projelerini sergileyerek kendilerini ifade etme fırsatı buldukları bir sahne ortamıdır.",
        title:"Sunum Alanı",
        pageText:"Sunum alanında öğrencilerimiz ürettikleri çalışmaları sunarlar. Özellikle online kaynakları etik çerçevede ve e-güvenliğe dikkat edilerek aktif olarak kullanırlar  ve  çalışmalarını dijital ortamlarda sunarlar; diğer öğrencilerle etkileşim kurarlar geri bildirim alırlar. Drama, tartışma ve panel etkinliklerimizi bu alanda yapılmaktadır. Ayrıca bu alan dahilinde 'Uzay Teması' çalışmamız devam etmektedir.Sunum alanında esnek tribün oturma düzeni, bilgisayar, HD projeksiyon, projeksiyon perdesi, ses sistemi, interaktif online araçlar,(Web 2.0,log,websitesi)karaoke mikrofon ve 3 boyutlu (ingilizce) ahşap dünya haritası bulunmaktadır.",

    },

    {
        id:6,
        imgs:[placeImg6,placeImg1,placeImg2,placeImg3,placeImg4,placeImg5],
